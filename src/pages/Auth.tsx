      ...
      <div className="flex-1 flex flex-col px-6 pt-8 pb-8 gap-8">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Button 
            type="button"
            variant="outline"
            className="flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-slate-300 font-medium py-3 rounded-xl transition-all duration-200 border border-slate-700 opacity-50 cursor-not-allowed"

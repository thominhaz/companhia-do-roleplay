...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      ...
      <main className="relative z-10 w-full max-w-7xl mx-auto flex flex-col xl:flex-row gap-6 lg:gap-8">
        {/* Login Card */}
          ...
          <div className="flex-1 flex flex-col px-6 pt-8 pb-8 gap-8">
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-slate-500 mt-1">Entre na sua conta Ward RPG</p>
              </div>
            </div>
        ...
        {/* Hero Section */}
        <section className="relative w-full max-w-md mx-auto bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl lg:rounded-3xl shadow-2xl overflow-hidden flex flex-col text-white border border-slate-800">
        ...
        <section className={`relative w-full max-w-md mx-auto bg-slate-900 rounded-2xl lg:rounded-3xl shadow-2xl overflow-hidden flex flex-col border border-slate-800 transition-all duration-300 ${activeCard === 'signup' ? 'ring-2 ring-emerald-500/50' : ''}`}>
          <div className="px-6 pt-8 pb-8 flex-1 flex flex-col gap-6">
            <header className="text-center space-y-2">
              ...
              <h2 className="text-2xl font-semibold text-slate-100 tracking-tight">Junte-se ao Ward RPG</h2>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button 
                type="button"
                variant="outline"
                className="flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-slate-300 font-medium py-3 rounded-xl transition-all duration-200 border border-slate-700"

    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Notas públicas e privadas da campanha</p>
        </div>
        <Button onClick={() => setShowNotes(true)} className="gap-2">
      ...
      <div className="bg-card rounded-xl p-6 border border-border text-center">
        ...
        <Button onClick={() => setShowNotes(true)} variant="outline">
          Ver Notas
        </Button>
      </div>
